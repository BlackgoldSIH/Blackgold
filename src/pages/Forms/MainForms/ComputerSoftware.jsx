  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const response = await axios.post(
            "http://127.0.0.1:8000/api/accounts/project-equipment/",
            formData,
            {
                headers: {
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>
        Details of Computers, Software, and Accessories Procured
      </h1>
      ...
      <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <table style={styles.table}>
            <thead>
              <tr>
                ...
                <th style={styles.th}>Present Condition</th>
                ...
                <tr key={index}>
                  ...
                  <td style={styles.td}>
                    <input
                      style={styles.input}
                      type="text"
                      value={equipment.presentCondition}
                      onChange={(e) =>
                        handleChange(e, index, "presentCondition")
                      }
        ...
        <div style={styles.formGroup}>
          <label style={styles.label}>
            Justification for Additional Procurement
          </label>
          <textarea
            style={styles.input}
            name="justification"
...
const styles = {
  ...
  addButton: {
    marginTop: "10px",
    padding: "10px 15px",
    backgroundColor: "#474656", // Changed from green (#4CAF50) to #474656
    color: "white",
    border: "none",
    borderRadius: "4px",
    cursor: "pointer",
...
export default ComputerSoftwareForm;
